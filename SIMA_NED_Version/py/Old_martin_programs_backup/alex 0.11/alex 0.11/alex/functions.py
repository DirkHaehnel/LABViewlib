...
#     fits = Property()
    ...
    run_fitting = Event
    # These booleans realy should not be here, as they regard the view and not the fitting process. Clean this in the feature.
    show_E = Bool(True)
    show_S = Bool(True)
    show_guesses = Bool(True)
    show_S_range = Bool(False)
...
func_dict = {'Gaussian': Gaussian, 'Zero': Zero, 'Constant': Constant, 'Exponent': Exponent, 'NegativeExponent': NegativeExponent, 'Linear': Linear}