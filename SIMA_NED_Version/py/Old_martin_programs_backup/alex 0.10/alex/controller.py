...
from alex.models import ReducParams, EvsS, BVA, Thresholds, PlotOptions, Metadata, FretCorrections, Dataset, AxisManager
from alex.views import EvsSView, BVAView, DatasetView
...
class Controller(HasTraits):
    ...
    analysis_type = Enum('evss', 'burst_viewer', 'bva_viewer', 'dataset')
