...
!MESSAGE 
!MESSAGE NMAKE /f "Get ACA Element U32.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "Get ACA Element U32.mak" CFG="Get ACA Element U32 - Win32 Debug"
!MESSAGE 
...
OutDir=.\Release
WkspDir=.
TargetName=Get ACA Element U32
InputPath=.\Release\Get ACA Element U32.dll
SOURCE="$(InputPath)"
...
WkspDir=.
TargetName=Get ACA Element U32
InputPath=.\Debug\Get ACA Element U32.dll
SOURCE="$(InputPath)"
