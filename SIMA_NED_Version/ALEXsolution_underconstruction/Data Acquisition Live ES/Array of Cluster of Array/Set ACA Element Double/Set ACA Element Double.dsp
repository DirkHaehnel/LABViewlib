...
!MESSAGE 
!MESSAGE NMAKE /f "Set ACA Element Double.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "Set ACA Element Double.mak" CFG="Get ACA Element U32 - Win32 Debug"
!MESSAGE 
...
OutDir=.\Release
WkspDir=.
TargetName=Set ACA Element Double
InputPath=.\Release\Set ACA Element Double.dll
SOURCE="$(InputPath)"
...
WkspDir=.
TargetName=Set ACA Element Double
InputPath=.\Debug\Set ACA Element Double.dll
SOURCE="$(InputPath)"
...
SOURCE=".\Set ACA Element Double.c"
# End Source File
# End Group
