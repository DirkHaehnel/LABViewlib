...
extern int _stdcall PH_OpenDevice(int devidx, char* serial); //new in v2.0
extern int _stdcall PH_CloseDevice(int devidx);  //new in v2.0
...
//for Routing
extern int _stdcall PH_GetRouterVersion(int devidx, char* model, char* vers);  //new in v2.0
